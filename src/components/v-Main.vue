                ...
                <div class="settings">
                    <div class="type">
                        ...
                        <div class="type__buttons">
                            <button :class="{ active: isActive, type__button: !isActive }" class="type__button_diff">
                                Дифференцированный
                            </button>
                            <button :class="{ active: !isActive, type__button: isActive  }" class="type__button_ann">
                                Аннуитентный
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="term">
                        <div class="term__title">
                            ...
                            <div class="term__value"><p>{{ loanTerm }}</p>
                                <p>месяцев</p></div>
                        </div>
                    ...
                    <div class="settings__description">Условия выдачи займа могут отличаться, исходя из анализа
